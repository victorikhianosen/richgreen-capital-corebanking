              ...
              <div class="col-md-12">
                <div class="panel widget">
                  ...
                  @include('includes.success')
                    ...
                    <form class="form-horizontal"  action="{{route('capital.store')}}" method="post" role="form" onsubmit="thisForm()">
                      @csrf
                      
                      <div class="form-group">
                        <label class="col-sm-3 control-label">Share Holders Name</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70 form-control" type="text" autofocus name="share_holder_name" id="fname" autocomplete="off" placeholder="Enter Category Name" value="{{old('name')}}">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70 form-control" type="number" name="percentage" step=".01" id="amt" autocomplete="off" placeholder="Enter Percentage" value="{{old('precentage')}}">
                        </div>
                      </div>
                      <div class="form-group">
