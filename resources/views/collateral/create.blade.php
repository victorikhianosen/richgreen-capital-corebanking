              ...
              <div class="col-md-12">
                <div class="panel widget">
                  ...
                  @include('includes.success')
                    ...
                    <form action="{{route('colla.store')}}" method="post" enctype="multipart/form-data" onsubmit="thisForm()">
                      @csrf
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" name="name" class="form-control" placeholder="Enter Value" required value="{{old('name')}}">
                  </div>
                  <div class="form-group">
                    <label for="">Value</label>
                      <input type="number" name="value" class="form-control" placeholder="Enter Value" required value="{{old('value')}}">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select name="status" class="form-control" id="" required>
                      <option disabled selected>Select...</option>
                      <option value="deposited_into_branch">Deposited into branch</option>
                      <option value="collateral_with_customer">Collateral with customer</option>
                      <option value="returned_to_customer">Returned to customer</option>
                      <option value="repossession_initiated">Repossession initiated</option>
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="notes" id="" class="form-control" cols="10" rows="4">{{old('notes')}}</textarea>
                  </div>
                  <div class="form-group">
                    <label>
                      Collateral Photo
