              ...
              <div class="col-md-12">
                <div class="panel widget">
                  ...
                  @include('includes.success')
                    ...
                    <form action="{{route('collatype.update',['id' => $ed->id])}}" method="post" onsubmit="thisForm()">
                      @csrf
                      <div class="form-group">
                        <label class="col-sm-12 control-label">Collateral Type Name</label>
                        <div class="col-sm-7">
                          <input type="text" name="name" placeholder="Enter Name" value="{{$ed->name}}" required class="col-sm-7 form-control">
                        </div>
                    </div>
