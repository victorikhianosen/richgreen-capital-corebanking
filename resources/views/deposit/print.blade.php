...
<div class="wrapper">
    ...
    <section class="invoice">
        ...
        <!-- info row -->
        <div class="row invoice-info" style="margin-left: 10px;margin-bottom:10px">
            <div class="col-sm-6">
                <address>
        ...
        <!-- /.row -->
        <!-- Table row -->
        <div style="margin-top:20px; margin-left: auto;margin-right: auto;font-size: 9px;">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-condensed table-sm">
                        ...
                        <th><b>Description</b></th>
                         <th><b>Tranx Type</b></th>
                        <!--<th><b>Status</b></th>-->
                        <th ><b>Debit</b></th>
                        <th ><b>Credit</b></th>
                        <th ><b>Balance({{!empty($customer->exrate) ? $customer->exrate->currency_symbol : $getsetvalue->getsettingskey('currency_symbol')}})</b></th>
                        </tr>
                        </thead>
                        <tbody>
