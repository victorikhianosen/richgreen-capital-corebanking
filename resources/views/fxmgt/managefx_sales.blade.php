                ...
                <div class="panel widget">
                    <div class="panel-heading">
                        <div style="text-align: end">
                          @can('fx sales') 
                           <a href="{{route('fx_sales.create')}}" class="btn btn-default"><span class="menu-icon"> <i class="fa fa-plus"></i> </span> Create Sales</a>
                           @endcan
                          </div>
                      </div>
                        ...
                        <table class="table table-striped table-bordered table-condensed table-hover" id="acoff">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <a href="javascript:void(0)" onclick="viewfxdetails('{{route('fx.sales.details',['id' => $sale->id])}}','sales')" title="View" class="btn menu-icon vd_bd-blue vd_blue btn-sm"><i class="fa fa-eye"></i> </a>
                                    </td>
                                </tr>
                                <?php $i++?>
                                @endforeach
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header vd_bg-blue vd_white">
        ...
        <h4 class="modal-title" id="myModalLabel">FX Sales Details</h4>
      </div>
