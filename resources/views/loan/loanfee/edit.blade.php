              ...
              <div class="col-md-12">
                <div class="panel widget">
                  ...
                  @include('includes.success')
                    ...
                    <form class="form-horizontal"  action="{{route('loan.fee.update',['id' => $ed->id])}}" method="post" role="form" onsubmit="thisForm()">
                      @csrf
                      
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Loan Fees Name</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" name="name" autofocus required value="{{$ed->name}}" autocomplete="off" placeholder="Enter Loan Fee Name">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <div class="vd_radio radio-success">
                            <input type="radio"  value="fixed" {{$ed->loan_fee_type == "fixed" ? "checked" : ""}} name="loan_fee_type" autocomplete="off" id="no4">
                            <label for="no4">I want Fee to be a fixed amount</label>
                          </div>
                          <div class="vd_radio radio-success">
                            <input type="radio" value="percentage"  {{$ed->loan_fee_type == "precentage" ? "checked" : ""}} autocomplete="off" name="loan_fee_type" id="yes4">
