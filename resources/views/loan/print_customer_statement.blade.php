...
<div style="width: 300px;margin-right: 20px;float: left">
    ...
    @foreach($loans as $loan)
        <h3 class="text-center"><b>Client Statement</b></h3>

        <div style="width: 1080px;height: 224px;margin-left: auto;margin-right: auto;border-top: solid thin rgba(2, 180, 209, 0.44);border-bottom: solid thin rgba(2, 180, 209, 0.44);padding: 20px;text-transform: capitalize">
            <div style="width: 300px;margin-right: 20px;float: left">
           ...
           Phone No: <b>{{$loan->customer->phone}} </b>
            ...
            <div style="width: 300px;margin-right: 40px;float: left">
                ...
                <b>Released Date</b><span class="pull-right">{{$loan->release_date}}</span><br><br>
                <b>Maturity Date</b><span class="pull-right">{{$loan->maturity_date}}</span><br><br>
                <b>Repayment Cycle</b><span class="pull-right" style="">{{$loan->repayment_cycle}}</span><br><br>
                <b>Principal</b><span class="pull-right" style="">{{$getsetvalue->getsettingskey('currency_symbol')."".number_format($loan->principal)}}</span><br><br>
        ...
        <div style="width: 980px;margin-top:30px;margin-left: auto;margin-right: auto;padding: 20px;text-transform: capitalize">
            ...
            @if(count($loan->repayments)>0)
                <table class="table table-condensed table-bordered table-striped">
                    ...
                    <tbody>
                    @foreach($loan->repayments as $key)
                        <tr>
                            ...
                            <td>{{$getsetvalue->getsettingskey('currency_symbol')."".number_format($key->amount,2)}}</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
