	...
	<tr>
		...
		<td class="header container">
				...
				<div class="content">
					<table>
					<tr>
						<td align="center"><img src="{{asset($getsetvalue->getsettingskey('company_logo'))}}" width="180" /></td>
									...
									<table align="left" class="column">
										<tr>
											<td>
                								...
                								Email: <strong><a href="mailto:support@assetmatrixmfb.com">support@assetmatrixmfb.com</a></strong></p>
