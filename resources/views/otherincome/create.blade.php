              ...
              <div class="col-md-12">
                <div class="panel widget">
                  ...
                  @include('includes.success')
                    ...
                    <form class="form-horizontal"  action="{{route('income.store')}}" method="post" enctype="multipart/form-data" role="form" onsubmit="thisForm()">
                      @csrf
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Other Income Type</label>
                        <div class="col-sm-7 controls">
                            <select name="income_types" required autocomplete="off" class="width-70 form-control" id="asty">
                                <option selected disabled>Select...</option>
                                @foreach ($incmtypes as $incmtyp)
                                   <option value="{{$incmtyp->id}}">{{$incmtyp->name}}</option>  
                                @endforeach
                            </select>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="number" required name="amount" id="brnd" value="{{old('amount')}}" autocomplete="off" placeholder="Enter Income Amount">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                            <input type="file" name="files" id="flel" class="width-70" accept=".jpg,.jpeg,.png,.docx,.doc,.pdf">
                        </div>
                      </div>
