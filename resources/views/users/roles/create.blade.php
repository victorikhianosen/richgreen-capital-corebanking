              ...
              <div class="col-md-12">
                <div class="panel widget">
                  ...
                  @include('includes.success')
                    ...
                    <form class="form-horizontal" id="changepass" action="{{route('roles.store')}}" method="post" role="form" onsubmit="thisForm()">
                      @csrf
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Role</label>
                        <div class="col-sm-7 controls">
                          <input class="width-70" type="text" name="role" value="{{old('role')}}" required placeholder="Enter Role" data-toggle="tooltip" data-placement="top" data-original-title="First Name">
                        </div>
                      </div>
